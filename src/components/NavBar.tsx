...
const FloatingNavbar: React.FC = () => {
  ...
  const [defaultUser, setUserDetails] = useState({
    avatar:
      "https://media.licdn.com/dms/image/v2/D4D03AQERRpmdQVLRWg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1704193940099?e=2147483647&v=beta&t=eHEewiQ1fPqvUONSeaa9u9p1CEaPvuzQb4j8oA6Zwqg",
    role: "Premium User",
    name: "",
    email: "",
  });
  ...
  const [notifications, setNotifications] = useState<NotificationType[]>([
    ...
    {
      id: "2",
      message: "Your order #46778 has shipped",
      time: "1 hour ago",
      read: false,
    },
  ...
  useEffect(() => {
    ...
    if (
      ...
      "aria-live" in document.createElement("div")
    ) {
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    >
                      {searchResults.length > 0 ? (
                        ...
                        searchQuery.trim().length >= 2 && (
                          <div
                            className="bg-gray-800 border border-gray-700 rounded-lg shadow-xl p-4 text-center text-gray-400"
                            role="status"
                          >
                            No results found
                          </div>
            ...
            <div className="relative" ref={notificationsRef}>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span
                    className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-red-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center"
                    aria-hidden="true"
                  >
                    {unreadCount}
                  </span>
                ...
                {notificationsOpen && (
                  ...
                  >
                    <div className="p-3 border-b border-gray-600 flex justify-between items-center">
                      <h3 className="font-medium" id="notifications-title">
                        Notifications
                      </h3>
                      {unreadCount > 0 && (
                        <button
                        ...
                        notifications.map((notification) => (
                          ...
                          >
                            <div className="flex items-start">
                              ...
                              {!notification.read && (
                                <span
                                  className="h-2 w-2 rounded-full bg-indigo-500 mt-1"
                                  aria-hidden="true"
                                ></span>
                              )}
                            </div>
                    ...
                    <Link href="/notifications" passHref>
                      <div
                        className="p-2 text-center text-sm text-indigo-400 hover:text-indigo-300 focus:outline-none focus-visible:underline border-t border-gray-600"
                        tabIndex={0}
                      >
                  ...
                  >
                    <div className="p-4 border-b border-gray-600 flex flex-col items-center">
                      <Image
                        ...
                        width={64}
                        height={64}
                        className="rounded-full border-2 border-indigo-500 mb-2"
                        unoptimized
                      />
                    ...
                    <div role="menu">
                      <Link href="/profile" passHref>
                        <div
                          className="flex items-center px-4 py-2 hover:bg-gray-700 cursor-pointer focus:outline-none focus:bg-gray-700"
                          role="menuitem"
                          tabIndex={0}
                        >
                          <FontAwesomeIcon
              ...
              <div className="px-4 py-2 space-y-2">
                <div className="flex items-center px-3 py-3 border-b border-gray-700">
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="rounded-full border-2 border-indigo-500 mr-3"
                    unoptimized
                  />
